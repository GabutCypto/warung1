...
<body>
    ...
    <section class="wrapper">
        <div class="flex justify-between gap-5 items-center bg-lilac py-3.5 px-4 rounded-2xl relative bg-left bg-no-repeat bg-cover bg-[url('{{ asset('assets/svgs/pipeline.svg') }}')]">
        ...
        <div id="categoriesSlider" class="relative">
            ...
            @forelse ($categories as $categori)
                <div class="inline-flex gap-2.5 items-center py-3 px-3.5 relative bg-white rounded-xl mr-4">
                    <img src="{{Storage::url($categori->icon)}}" class="size-10" alt="">
    ...
    <!-- Explore -->
<section class="wrapper">
    <div style="background-image: url('{{ asset('assets/svgs/doctor-help.svg') }}')" class="bg-lilac py-3.5 px-5 rounded-2xl relative bg-right-bottom bg-no-repeat bg-auto">
...
<section class="wrapper flex flex-col gap-2.5 pb-40">
    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
            <img src="{{ asset('assets/images/product-2.webp') }}" class="w-full max-w-[70px] max-h-[70px] object-contain" alt="">
        ...
        <!-- Enoki Pro -->
        <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
            <img src="{{ asset('assets/images/product-1.webp') }}" class="w-full max-w-[70px] max-h-[70px] object-contain" alt="">
            <div class="flex flex-wrap items-center justify-between w-full gap-1">
                <div class="flex flex-col gap-1">
                    <a href="details.html"
                        class="text-base font-semibold stretched-link whitespace-nowrap w-[150px] truncate">
        ...
        <!-- Veetax Bora -->
        <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
            <img src="{{ asset('assets/images/product-4.webp') }}" class="w-full max-w-[70px] max-h-[70px] object-contain" alt="">
            <div class="flex flex-wrap items-center justify-between w-full gap-1">
                <div class="flex flex-col gap-1">
                    <a href="details.html"
                        class="text-base font-semibold stretched-link whitespace-nowrap w-[150px] truncate">
